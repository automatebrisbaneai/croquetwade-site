...
// Game iframes
var GAME_WINDOWS = [
  { id: 'minesweeper-win', title: 'Minesweeper', emoji: '\u{1F4A3}', src: 'games/minesweeper.html?embed=1', w: 700, h: 700, top: 30, left: 'calc(50% - 250px)' },
  { id: 'snake-win', title: 'Snake', emoji: '\u{1F40D}', src: 'games/snake.html?embed=1', w: 700, h: 700, top: 30, left: 'calc(50% - 250px)' },
  { id: 'solitaire-win', title: 'Solitaire', emoji: '\u2660', src: 'games/solitaire.html?embed=1', w: 800, h: 700, top: 20, left: 'calc(50% - 300px)' },
  { id: 'hearts-win', title: 'Hearts', emoji: '<span style="color:#c00">\u2665</span>', src: 'games/hearts.html?embed=1', w: 750, h: 700, top: 25, left: 'calc(50% - 275px)' },
...
function buildGamesFolder() {
  ...
  h += '</div><div style="background:#ece9d8;padding:2px 8px;font-size:11px;color:#808080;border-top:1px solid #aca899;">11 objects</div></div>';
  return h;
}
